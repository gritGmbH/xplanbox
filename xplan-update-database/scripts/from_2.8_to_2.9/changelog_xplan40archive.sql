...
CREATE TABLE xplan40archive.databasechangeloglock (ID INT NOT NULL, LOCKED BOOLEAN NOT NULL, LOCKGRANTED TIMESTAMP WITHOUT TIME ZONE, LOCKEDBY VARCHAR(255), CONSTRAINT PK_DATABASECHANGELOGLOCK PRIMARY KEY (ID));
...
-- Lock Database
UPDATE xplan40archive.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'lgvxplanisk (fe80:0:0:0:216:3eff:fe0c:7064%eth0)', LOCKGRANTED = '2018-10-25 15:50:29.914' WHERE ID = 1 AND LOCKED = FALSE;
