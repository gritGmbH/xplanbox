...
-- Lock Database
UPDATE xplan41nsmpre.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'lgvxplanisk (fe80:0:0:0:216:3eff:fe0c:7064%eth0)', LOCKGRANTED = '2018-10-25 15:50:40.758' WHERE ID = 1 AND LOCKED = FALSE;
