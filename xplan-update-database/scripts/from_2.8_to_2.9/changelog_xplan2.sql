...
-- Lock Database
UPDATE xplan2.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'lgvxplanisk (fe80:0:0:0:216:3eff:fe0c:7064%eth0)', LOCKGRANTED = '2018-10-25 15:50:12.419' WHERE ID = 1 AND LOCKED = FALSE;
