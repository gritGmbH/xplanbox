...
public class XplanFlattenPropertyTest {
    ...
    public void testEvaluateWithGenericFeature() {
        ...
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:flaechenteil" ), new XPlanSynthesizer() );
    ...
    public void testEvaluateWithXpBegruendungAbschnitt() {
        ...
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[Das ist Begründungsabschnitt No 2]", value.toString() );
    }

    @Test
    public void testEvaluateWithXpExterneReferenz() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Plan_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:refLegende" ) , new XPlanSynthesizer());
        PrimitiveValue value = expr.evaluate( feature );
    ...
    public void testEvaluateWithXpExterneReferenzPlan() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Plan_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:refRechtsplan" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[/getAttachment?featureID=BP_Plan_1&filename=B-Plan_Klingmuehl_Heideweg.tif][/getAttachment?featureID=BP_Plan_1&filename=georef]",
                      value.toString() );
    }
    ...
    public void testEvaluateWithXpGenerAttribut() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Baugebiet_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:hatGenerAttribut" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
    ...
    public void testEvaluateWithXpHoehenangabe() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Baugebiet_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:hoehenangabe" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[abweichenderHoehenbezug=1;hoehenbezug=absolutNHN;bezugspunkt=FH;hMin=1;hMax=2;hZwingend=3;h=4;]", value.toString() );
    }

    @Test
    public void testEvaluateWithXpRasterplanBasis() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Bereich_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:rasterBasis" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[/getAttachment?featureID=XP_RASTERPLANBASIS_1&filename=B-Plan_Klingmuehl_Heideweg_Karte.tif][/getAttachment?featureID=XP_RASTERPLANBASIS_1&filename=B-Plan_Klingmuehl_Heideweg_Karte.tfw]",
                      value.toString() );
    }
    ...
    public void testEvaluateWithXpRasterplanAenderung() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Bereich_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:rasterAenderung" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[/getAttachment?featureID=BP_RASTERPLANAENDERUNG_1&filename=B-Plan_Klingmuehl_Heideweg_Karte1.tif][/getAttachment?featureID=BP_RASTERPLANAENDERUNG_1&filename=B-Plan_Klingmuehl_Heideweg_Karte1.tfw][/getAttachment?featureID=BP_RASTERPLANAENDERUNG_2&filename=B-Plan_Klingmuehl_Heideweg_Karte2.tif][/getAttachment?featureID=BP_RASTERPLANAENDERUNG_2&filename=B-Plan_Klingmuehl_Heideweg_Karte2.tfw]",
                      value.toString() );
    }
    ...
    public void testEvaluateWithXpTextAbschnitt() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Plan_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:texte" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[Das ist Textabschnitt No 1 (Keine gesetzliche Grundlage)][Das ist Textabschnitt No 2 (Gesetzliche Grundlage: BGB)]", value.toString() );
    }
    
    @Test
    public void testEvaluateWithXpGemeinde() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Plan_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:gemeinde" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[ags=4011000;rs=rs;gemeindeName=Bremen;ortsteilName=Whatever;]", value.toString() );
    }

    @Test
    public void testEvaluateXpVerfahrensMerkmal() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_41, "BP_Plan_1" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:verfahrensMerkmale" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
