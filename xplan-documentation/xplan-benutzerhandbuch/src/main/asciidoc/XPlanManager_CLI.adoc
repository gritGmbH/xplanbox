...
So kann über das Property _defaultBboxIn4326_ konfiguriert werden, welche
default Bounding-Box während
...
Usage: XPlanManager <options>
 ...
 -delete <planid> [--workspace <workspace verzeichnis>]
...
----
./XPlanManager -import ~/test-data/V4_1_ID_103-25832.zip --managerconfiguration .
----
