...
erfolgt mit dem Zusatzparameter `–force`.
...
Zusatzparameter `–workspace` das entsprechende Verzeichnis übergeben
werden.
...
Zusatzparameter `–managerconfiguration` die entsprechende Konfiguration
übergeben werden.
