...
----
XPlanValidator -validate Plan.zip -vo ignore-orientation -vo min-node-distance=1 -vo skip-flaechenschluss -vo skip-geltungsbereich
----
...
Zuordnung der Wert:
  ...
  * min-node-distance -> Mindesabstand von Stützpunkten in m
