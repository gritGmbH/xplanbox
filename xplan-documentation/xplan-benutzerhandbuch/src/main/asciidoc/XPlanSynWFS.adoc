 ...
 * urn:ogc:def:query:OGC-WFS::PlanNameAndTypes
...
Die StoredQuery _PlanNameAndTypes_ gibt dagegen alle Vektordaten der mit dem Parameter _typeNames_ angefragten feature types zurück.

Um die Eindeutigkeit der StoredQueries _PlanId_, _PlanName_ und _PlanNameAndTypes_ zu gewährleisten,
