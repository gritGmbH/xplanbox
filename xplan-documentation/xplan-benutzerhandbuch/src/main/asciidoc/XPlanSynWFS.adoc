...
Beispielanfrage für den Plan mit dem Namen _Musterdorf_ mit _srsName=EPSG:4326_:

----
http://<host>:<port>/xplansyn-wfs/services/xplansynwfs?request=GetFeature&service=WFS&version=2.0.0&StoredQuery_ID=urn:ogc:def:query:OGC-WFS::PlanName&planName=Musterdorf&srsName=EPSG:4326
----
