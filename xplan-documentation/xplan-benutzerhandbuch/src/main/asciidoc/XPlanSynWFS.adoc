...
Die StoredQuery _PlanNameAndType_ gibt dagegen die Vektordaten des mit dem Parameter _typeNames_ angefragten feature type zurück, es kann an dieser Stelle nur ein feature type angegeben werden.
