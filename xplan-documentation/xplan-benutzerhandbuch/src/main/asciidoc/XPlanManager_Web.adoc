...
Bei der Validierung werden immer die syntakstiche und Basis-Geometrische Prüfung (s. Abschnitt <<xplanvalidator-web-geometrisch>>) ausgeführt. Diese stellen sicher, dass ein Plan keine schwerwiegenden Fehler hat, die einen Import verhindern würden.
