...
IMPORTANT: Die Möglichkeit einen Gültigkeitszeitraum anzugeben ist veraltet, das Editieren des Gültigkeitszeitraums wird in zukünftigen Versionen der xPlanBox entfernt.
