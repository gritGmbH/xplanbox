...
ist beschränkt auf BPläne in den XPlanGML Versionen 3.0, 4.1, 5.0 und 5.1. Die Editieransicht öffnet sich durch den Klick auf den
...
Abhängig von den Benutzerrechten können Pläne im Datenthema INSPIRE Planned Land Use veröffentlicht werden. Fehlen dem Benutzer die entsprechenden Rechte ist die Funktion deaktiviert und der Button __Bereitstellung als INSPIRE Datensatz__ wird nicht dargestellt. Die Funktion ist beschränkt auf BPläne in den XPlanGML Versionen 3.0, 4.1, 5.0 und 5.1.
...
NOTE: Die Bereitstellung als INSPIRE PLU Datensatz steht nur für BPläne in den XPlanGML Versionen 3.0, 4.1, 5.0 und 5.1 zur Verfügung.