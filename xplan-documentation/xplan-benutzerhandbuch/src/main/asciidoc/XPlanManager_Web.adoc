...
Die Rasterbasis kann nur editiert werden, wenn ein Plan ein Objekt vom Typ BP_Bereich besitzt. Ist dies nicht der Fall, wird ein entsprechender Hinweis in der Editieroberfläche angegeben. Die Angabe einer Rasterbasis kann in diesem Fall nicht erfolgen.
