 ...
 * Das XPlanGML-Instanzdokument beinhaltet nur ein oder mehrere Elemente vom Typ `<xplan:XP_PLAN/>`. Beinhaltet eine Datei mehrere dieser Elemente, so dürfen keine nicht referenzierte Features im XPlanGML-Instanzdokument vorkommen, wie z.B. ein freies Präsentationsobjekt ohne Bezug zum Bereich!
