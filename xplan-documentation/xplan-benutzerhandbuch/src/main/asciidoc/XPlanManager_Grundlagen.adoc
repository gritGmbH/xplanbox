...
NOTE: *Wichtig*: Dateinamen dürfen keine Sonderzeichen wie z.B. '/', '\', ' ', '"' (doppeltes oder einfaches Anführungszeichen) oder auch Umlaute beinhalten.
Gross- und Kleinschreibung in den Dateinamen (auch der Dateiendung) werden berücksichtigt und müssen vollständig mit den Referenzen im Dokument
übereinstimmen!
