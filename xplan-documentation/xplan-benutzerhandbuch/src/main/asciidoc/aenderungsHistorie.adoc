...
- Aktualisierung der Validierungsregeln auf v1.1.2 für XPlanGML Version 6.0.2
- Korrektur der Reihenfolge der Textabschnitte im XPlanSynWMS und GFI XPlanWMS wenn kein Schlüssel angegeben ist
- Fehlende Bearbeitungsmnöglihchkeit des Gültigkeitszeitraums im Editiermodus wiederhergestellt
...
- Fehlerkorrektur von parallel ausgeführten Validierungen
