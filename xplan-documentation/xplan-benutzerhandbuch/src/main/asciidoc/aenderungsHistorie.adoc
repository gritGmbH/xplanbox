...
[[Aenderungshistorie-4.2.1]]
=== Version 4.2.1

==== Erweiterungen
- (TT_10410) Erweiterung des Betriebshandbuchs um Datenbankschema der XPlanDB
...
- Editieren von Referenzen in 5.3 unvollständig
- Links zu Konformitätsregeln aktualisiert
- Editieren von Rasterbasis deaktiveren wenn ein BP_Plan kein BP_Bereich referenziert
