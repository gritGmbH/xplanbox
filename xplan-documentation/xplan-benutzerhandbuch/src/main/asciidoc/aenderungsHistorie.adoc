...
==== Fehlerbehebungen
 ...
 - Bereitstellung von XPlanGML 4.1 Plänen in XPlanGML 5.1 über einen neuen WFS
 - Anzeige der Planliste im XPlanManager beschleunigen
 - Hinzufügen von Rasterdaten im Editiermodus ermöglichen
 ...
 - Ausgabe der GML ID für die allgemeinen Regeln 2.1.2.1, 2.1.3.1, 2.2.1.1
 - (TT_10208) Korrektur der Validierungsregeln für BP_LandwirtschaftsFlaeche (XPlanGMl 5.1)
 - Korrekturen der Konformitätsbedingungen für 5.0 und 5.1 übernehmen
