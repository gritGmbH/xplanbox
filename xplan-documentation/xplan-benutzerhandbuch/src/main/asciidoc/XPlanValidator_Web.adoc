...
WARNING: Die Größe eines Plans hat unmittelbare Auswirkungen auf die Dauer der Validierung.
...
Zusätzlich können noch Profile ausgewählt werden, die zusätzliche Validierungsregeln enthalten können. Ist ein Profil oder mehrere Profile für den XPlanValidator konfiguriert, dann werden diese unterhalb der Validierungstypen angezeigt.
