...
inklusive Anhänge) größer 50 MB und XPlanGML-Dateien größer 2 MB können die Systemstabilität
...
Im XPlanWMS ist der Umfang der Darstellung von Präsentationsobjekten nurt eingeschränkt implementiert. Über die folgenden Layern werden diese angezeigt:
