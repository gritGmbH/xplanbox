...
Wird ein Text, Dokument oder eine Rasterbasis mit dem Namen _xplan.gml_ über die Editorfunktion des XPlanManagerWeb hinzugefügt, kann dieses XPlanArchiv nicht mehr geöffnet werden. Das System zeigt dann den Fehler "500" an. Der Fehler kann nicht behoben werden. Das XPlanArchiv muss aus der Datenhaltung entfernt werden.
