...
Folgende Validierungsregeln werden derzeit nicht durch den Validiator geprüft:
...
Der Ausschluss von gemischter Geometrie ist bereits durch das GmlProfil abgedeckt. Verstösse fallen somit bereits bei der syntaktischer Validierung auf.
