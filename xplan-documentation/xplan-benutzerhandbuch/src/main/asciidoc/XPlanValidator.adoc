...
Der XPlanValidator ist ein Prüftool, das ein XPlanArchiv und die darin enthaltene XPlanGML-Datei bzw. eine XML-oder eine GML-Datei validieren kann. Dabei bietet der XPlanValidator verschiedene Prüfmethoden zur Validierung an.
