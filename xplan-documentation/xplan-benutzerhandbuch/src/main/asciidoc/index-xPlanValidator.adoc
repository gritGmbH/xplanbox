...
Zum Lieferumfang der xPlanBox gehören Bibliotheken und andere Softwareprogramme von Drittanbietern. Dabei handelt es sich um Open-Source Software, die im Rahmen der Bestimmungen der
