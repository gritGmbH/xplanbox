...
* _xplan-webservices-workspaces-xplan-manager-workspace.zip_
* _xplan-webservices-workspaces-xplansyn-wfs-workspace.zip_
* _xplan-webservices-workspaces-xplansyn-wms-workspace.zip_
* _xplan-webservices-workspaces-xplan-wfs-workspace.zip_
* _xplan-webservices-workspaces-xplan-validator-wms-memory-workspace.zip_ *oder* _xplan-webservices-workspaces-xplan-validator-wms-sql-workspace.zip_ (siehe <<konfiguration-xplanvalidatorwms>>)
* _xplan-webservices-workspaces-xplan-inspireplu-workspace.zip_ (optional)
...
* _xplan-dokumente-config_ (optional)
