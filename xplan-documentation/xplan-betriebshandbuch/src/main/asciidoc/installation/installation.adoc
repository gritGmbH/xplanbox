...
* XPlanUpdateDatabaseCLI: _xplan-update-data-cli/bin/databaseUpdate_ - wird  für eine Aktualisierung des Datenbestands der xPlanBox benötigt, weitere Informationen befinden sich im Abschnitt <<aktualisierung>>). Die Funktionen im Überblick:
