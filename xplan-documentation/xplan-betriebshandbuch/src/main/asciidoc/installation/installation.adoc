...
** _xplan-update-data-cli/bin/artefactsTableUpdate_ - ermöglicht die Aktualisierung der im XPlanManager-Schema gespeicherten Informationen zu den Artefakten (neu in Version 7.0). Der Aufruf des Tools mit `--help` liefert Hinweise zur Verwendung.
