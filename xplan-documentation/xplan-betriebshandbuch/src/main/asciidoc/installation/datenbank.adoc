...
Das Anlegen der Datenbank XPlanDB kann mit einem beliebigen Datenbankwerkzeug, wie z. B. https://www.pgadmin.org[pgAdmin], erfolgen.

Dafür müssen die folgenden Schritte ausgeführt werden:
