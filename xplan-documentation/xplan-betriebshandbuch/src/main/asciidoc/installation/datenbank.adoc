...
die Datenbankerzeugung mittels des XPlanManagerCLI durchgeführt werden:

----
XPlanManager -createdb 'xplanbox' jdbc:postgresql://localhost:5432 -u postgres -p postgres
----

Informationen zu den Befehlen und der Erzeugung der Datenbank finden sich im Abschnitt XPlanManagerCLI im XPlanBenutzerhandbuch. Die erforderlichen Informationen sind im Abschnitt "Alternativer Betriebsmodus" beschrieben.
