...
GDAL-Integration. Es wird GDAL in der Version 2.4 empfohlen. Die GDAL Unterstützung ist optional, die Konfiguration im
...
(JDK), z.B.: `C:\Program Files (x86)\Java\jdk1.8`
