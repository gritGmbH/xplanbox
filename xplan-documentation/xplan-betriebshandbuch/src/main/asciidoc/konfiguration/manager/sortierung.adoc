...
Betriebs führt zu unterschiedlichen Grundlagen der Sortierung. Über das
Tool `sortDateUpdate` des XPlanUpdateDataCLI kann die Änderung für bereits importierte Daten nachgezogen werden. Der Aufruf des XPlanUpdateDataCLI ist im Kapitel <<kommandozeilen-anwendungen>> beschrieben.
