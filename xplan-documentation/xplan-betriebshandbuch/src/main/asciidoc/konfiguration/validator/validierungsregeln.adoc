...
wenn z. B. die semantischen Validierungsregeln angepasst, erweitert oder durch eine aktuellere Version ersetzt werden sollen.
...
bereitzustellen, um die Unabhängigkeit zu externen Ressourcen
sicherzustellen.
