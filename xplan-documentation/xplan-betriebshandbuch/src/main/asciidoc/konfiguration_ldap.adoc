...
ist, besitzt alle Rechte für die den Bezirken zugeordneten Pläne.
...
Um die Absicherung zu deaktivieren, müssen der im Abschnitt <<enable_security>> genannte Servlet-Filter aus der web.xml
