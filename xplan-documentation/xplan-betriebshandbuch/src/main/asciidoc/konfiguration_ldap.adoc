...
Der Zugriff auf den XPlanManagerWeb kann somit auf Benutzer eingeschränkt werden, die sich erfolgreich über LDAP
anmelden können. Zu jeden erfolgreich authentifizierten Benutzer können über LDAP auch Rolleninformationen
abgerufen werden.
