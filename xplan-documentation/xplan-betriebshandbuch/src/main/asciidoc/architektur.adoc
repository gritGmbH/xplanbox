...
* <<xplandokumenten-api, XPlanDokumentAPI>>
...
Die Gesamtarchitektur aller zuvor aufgelisteten Komponten wird in der folgenden Abbildung dargestellt:
...
Die optionale Komponente XPlanDokumentAPI stellt eine REST-Schnittstelle bereit, über die zu einem Plan zugehörigen Dokumente abgerufen werden können.
