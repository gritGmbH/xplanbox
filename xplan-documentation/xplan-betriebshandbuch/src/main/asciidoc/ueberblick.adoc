...
NOTE: Empfohlen wird OpenJDK 11.0.13+8.
...
NOTE: Die minimale Anforderung an den Applikationsserver ist das Java EE 7 Web
...
NOTE: Empfohlen wird PostgreSQL 11+ mit PostGIS 3.0+.
...
Optional kann die Installation von https://github.com/halestudio/hale-cli/[HALE CLI] erforderlich sein. HALE CLI wird für die Transformation von Daten der xPlanBox verwendet. Weitere Informationen zur Installation befinden sich im Abschnitt <<installation-hale-cli>>.
