...
Zur Unterstützung bei der Installation kann für das Ablegen bzw. für den Austausch der Web-Archive sowie die Aktualisierung der betroffenen Konfigurationsdateien das folgende Skript genutzt werden. Dieses muss je nach Umgebung und eingesetzten Software-Versionen noch angepasst werden:
