...
Die XPlanDB kann mit Hilfe des Bash-Skripts `setup_db.sh` (Datei liegt im https://gitlab.opencode.de/diplanung/ozgxplanung/-/blob/main/xplan-database/xplan-database-docker/setup_db.sh[Open CoDE GitLab-Repository]) aufgesetzt werden.
