[appendix]
== Checkliste für Aktualisierung einer Installation
...
=== Checkliste für Aktualisierung der Webanwendungen
...
=== Checklist für die Übernahme der Konfigurationen aus deegree Workspaces
...
* [ ] Konfiguration im Verzeichnis _<DEEGREE_WORKSPACE_ROOT>/xplansyn-wms-workspace/_ aktualisiert:
  ...
  ** _<BACKUP_CONFIG>/xplansyn-wms-workspace/gdal.xml_ kopiert und die Datei _gdal.ignore_ entfernt, wenn GDAL genutzt wird (siehe <<installation-gdal>> und <<konfiguration-gdal>>)
