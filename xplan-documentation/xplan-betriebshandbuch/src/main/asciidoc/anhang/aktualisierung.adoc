...
=== A1: Aktualisierung der Webanwendungen
...
==== A2 Konfiguration der Webanwendung übertragen
...
1. Alle deegree Workspace Verzeichnisse aus _<DEEGREE_WORKSPACE_ROOT>_ und _<XPLANBOX_CONFIG>_ sichern und im Verzeichnis _<BACKUP_CONFIG> ablegen.
...
[appendix]
[[appendix_bbox_cache_properties]]
== bbox_cache.properties Konfiguration

Im Folgenden befindet sich eine vollständige __bbox_cache.properties__. Diese ist vorkonfiguriert auf ganz Deutschland:
