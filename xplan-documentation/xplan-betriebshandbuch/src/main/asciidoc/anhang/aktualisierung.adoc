...
Als Basisverzeichnisse werden im Folgenden _<DEEGREE_WORKSPACE_ROOT>_, _<XPLANBOX_CONFIG>_ und temporär zur Ablage der Sicherungskopie _<BACKUP_CONFIG>_ (z.B. _/home/user/tmp_) sowie _<WORK_DIR> als Download-Verzeichnis mit der entpackten Distributionsdatei vorausgesetzt.
...
1. Alle Verzeichnisse mit den Konfigurationsdateien aus _<DEEGREE_WORKSPACE_ROOT>_ und _<XPLANBOX_CONFIG>_ sichern und im Verzeichnis _<BACKUP_CONFIG>_ ablegen.
...
3. XPlanManager und XPlanValidator Konfigurationsdateien nach _<XPLANBOX_CONFIG>_ kopieren.
4. Die Dateien _console.pw_ und _webapps.properties_ aus _<BACKUP_CONFIG>_ zurückkopieren.
...
Konfiguration im Verzeichnis _<XPLANBOX_CONFIG>/xplan-manager-config/_ aktualisieren:
...
* _<XPLANBOX_CONFIG>/synthesizer_ kopieren
