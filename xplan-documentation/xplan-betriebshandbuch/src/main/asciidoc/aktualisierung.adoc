...
Mit der Version 6.0 der xPlanBox wird die Version XPlanGML 6. unterstützt. Weiterhin sind einige Erweiterungen und Verbesserungen an den Komponenten der xPlanBox vorgenommen worden.
