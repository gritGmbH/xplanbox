...
Für eine Installation der Bugfix-Version ist ein Austausch der beiden Web-Apps erforderlich:
...
* Ausführen des Kommandozeilenwerkzeug __reSynthesizer__ im Modul _xplan-update-database-cli_ zur Aktualisierung der XPlanSyn-Datenhaltung
