...
Mit der Version 3.4 der xPlanBox sind einige Erweiterungen und Fehlerbehebungen vorgenommen worden.

Für die Aktualisierung auf die Version 3.4 sind folgende Schritte auszuführen:

* Aktualisierung der Datenbank:
** Ausführen der Skripte im Verzeichnis _from_3.3_to_3.4_ im Modul xplan-update-database. Die Tabelle _xplanmgr.plans_ wurde um die Spalte _internalid_ erweitert.
