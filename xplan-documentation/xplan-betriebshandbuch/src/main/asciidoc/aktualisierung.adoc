...
Zur Aktualisierung der Daten stehen Kommandozeilenwerkzeuge im XPlanUpdateDataCLI zur Verfügung. Diese müssen nacheinander ausgeführt werden:
- _artefactsTableUpdate_
- _bereichUpdate_
- _destrictUpdate_
- _reSynthesizer_
