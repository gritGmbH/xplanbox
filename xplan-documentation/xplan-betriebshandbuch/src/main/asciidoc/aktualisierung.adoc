...
Bei einer vollständigen Aktualisierung kann auch das Installationsskript aus dem Kapitel <<installation-über-ein-install-skript, Installation über ein Installations-Skript>> (s. <<Installations-Skript, Anhang>>) verwendet werden.
