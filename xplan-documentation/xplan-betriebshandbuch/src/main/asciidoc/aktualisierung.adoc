...
----
unzip ${WORK_DIR}/bin/xplan-manager-cli.zip
unzip ${WORK_DIR}/bin/xplan-transform-cli.zip
unzip ${WORK_DIR}/bin/xplan-update-data-cli.zip
unzip ${WORK_DIR}/bin/xplan-validator-cli.zip
unzip ${WORK_DIR}/bin/xplan-validatedb-cli.zip
unzip ${WORK_DIR}/bin/xplan-evaluation-schema-synchronize-cli.zip
----
