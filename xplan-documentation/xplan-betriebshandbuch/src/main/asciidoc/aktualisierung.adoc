...
Mit der Version 7.1 erfolgte die Integration des MapProxy in die xPlanBox. Die Komponente ist optional und kann bei Bedarf wie im Abschnitt <<installation-mapproxy>> beschrieben installiert und konfiguriert werden.
