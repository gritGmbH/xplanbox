...
* Anlegen des _xplan-validator-wms-workspace_ Workspaces (s. <<konfiguration>>).
...
Seit der Version 3.3 wird die XPlanGML Version 2.0 nicht mehr unterstützt.

* Aktualisierung der Datenbank:
** Ausführen der Skripte im Verzeichnis _from_3.2_to_3.3_ im Modul xplan-update-database in der vorgegebenen Reihenfolge.