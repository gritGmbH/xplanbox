...
** _xplan-validator-web.war_
** _xplan-manager-web.war_
* Austausch und Ausführung des Kommandozeilenwerkzeugs __artefactsTableUpdate__ im Modul _xplan-update-data-cli_ zur Aktualisierung der XPlanDB, wenn dies beim der Installation der Version 7.0 oder 7.0.1 nicht erfolgreich ausgeführt werden konnte.
