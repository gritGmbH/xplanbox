...
| 7.2.2 (<<aktualisierung-version-7.2.2, Details>>)     | nein | nein
...
[[aktualisierung-version-7.2.2]]
=== Aktualisierung auf die Version 7.2.2
...
NOTE: Wurden Pläne mit mehr als drei Nachkommastellen in den Geometrien mit einer älteren Version der xPlanBox importiert, müssen die Originaldaten neu importiert werden.
