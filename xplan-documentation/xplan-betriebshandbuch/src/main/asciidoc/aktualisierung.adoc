...
Wenn die neuen Features "Kartenvorschau" (siehe <<kartenvorschau-validator>>) und "ausgelagerte semantische Validierungsregeln" (siehe <<semantische-validierungsregeln-validiator>>) im XPlanValidatorWeb genutzt werden sollen, sind folgende Anpassungen nötig.
