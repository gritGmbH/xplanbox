...
| 4.2.1            | ja (<<aktualisierung-auf-die-version-4.2.1-der-xplanbox, Details>>)  |
...
[[aktualisierung-auf-die-version-4.2.1-der-xplanbox]]
=== Aktualisierung auf die Version 4.2.1 der xPlanBox
