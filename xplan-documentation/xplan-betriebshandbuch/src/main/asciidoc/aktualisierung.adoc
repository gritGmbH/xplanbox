...
----
unzip ${WORK_DIR}/bin/xplan-manager-cli-${VERSION}.zip
unzip ${WORK_DIR}/bin/xplan-transform-cli-${VERSION}.zip
unzip ${WORK_DIR}/bin/xplan-update-data-cli-${VERSION}.zip
unzip ${WORK_DIR}/bin/xplan-validator-cli-${VERSION}.zip
unzip ${WORK_DIR}/bin/xplan-validatedb-cli-${VERSION}.zip
unzip ${WORK_DIR}/bin/xplan-evaluation-schema-synchronize-cli-${VERSION}.zip
----
