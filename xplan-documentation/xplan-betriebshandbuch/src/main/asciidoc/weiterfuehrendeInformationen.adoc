...
Die folgende Tabelle zeigt die in der XPlanDB enthaltenen Datenbankschema und die auf diese Schema zugreifenden Komponenten am Beispiel der festgestellten Pläne bei <<systemarchitektur-und-schnittstellen,separater Datenhaltung>>.
