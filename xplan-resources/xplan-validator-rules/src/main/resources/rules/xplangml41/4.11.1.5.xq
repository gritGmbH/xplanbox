...
(
  every $h in //BP_VerEntsorgung[weitereBesondZweckbestimmung1] satisfies
...
and
(
  every $h in //BP_VerEntsorgung[weitereBesondZweckbestimmung2] satisfies
...
and
(
  every $h in //BP_VerEntsorgung[weitereBesondZweckbestimmung3] satisfies
...
and
(
  every $h in //BP_VerEntsorgung[weitereBesondZweckbestimmung4] satisfies
