...
(
  every $h in //FP_Gemeinbedarf[weitereBesondZweckbestimmung1] satisfies
...
and
(
  every $h in //FP_Gemeinbedarf[weitereBesondZweckbestimmung2] satisfies
...
and
(
  every $h in //FP_Gemeinbedarf[weitereBesondZweckbestimmung3] satisfies
...
and
(
  every $h in //FP_Gemeinbedarf[weitereBesondZweckbestimmung4] satisfies
...
and
(
  every $h in //FP_Gemeinbedarf[weitereBesondZweckbestimmung5] satisfies
  
  (: Wenn weitereBesondZweckbestimmung aus Ziffern besteht, :)
  if (
    every $weitereBesondZweckbestimmung in $h/weitereBesondZweckbestimmung5/text() satisfies
    matches($weitereBesondZweckbestimmung,"[0-9]")
  )
  (: dann überprüfe, ob weitereZweckbestimmung ebenfalls aus Ziffern besteht. :)
  then
    ...
    (: Wenn weitereZweckbestimmung aus Ziffern besteht, :)
    if (
      every $weitereZweckbestimmung in $h/weitereZweckbestimmung5/text() satisfies
      matches($weitereZweckbestimmung,"[0-9]")
    )
    (: dann überprüfe, ob weitereZweckbestimmung in weitereBesondZweckbestimmung enthalten ist. :)
    then
      contains($weitereBesondZweckbestimmung, $weitereZweckbestimmung) or not(exists($h/weitereZweckbestimmung5))
    else boolean('false')
