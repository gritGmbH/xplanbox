...
-- Lock Database
UPDATE xplansyn.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'cpe-172-101-0-1.maine.res.rr.com (172.101.0.1)', LOCKGRANTED = '2021-01-21 10:57:33.362' WHERE ID = 1 AND LOCKED = FALSE;
...
-- Changeset changelog_xplansyn.xml::1611222917373-1::lyn (generated)
...
INSERT INTO xplansyn.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1611222917373-2', 'lyn (generated)', 'changelog_xplansyn.xml', NOW(), 2, '8:fae8d9e32acef906851c8a275dd206ef', 'createTable tableName=xplan_bp_zentralerversorgungsbereich', '', 'EXECUTED', NULL, NULL, '3.6.2', '1223053834');

-- Changeset changelog_xplansyn.xml::1611222917373-3::lyn (generated)
