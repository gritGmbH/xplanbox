...
CREATE INDEX spatial_idx_318 ON xplansyn.xplan_bp_flaecheohnefestsetzung(xplan_position);
...
CREATE INDEX spatial_idx_319 ON xplansyn.xplan_bp_zentralerversorgungsbereich(xplan_position);
...
CREATE INDEX spatial_idx_320 ON xplansyn.xplan_fp_darstellungnachlandesrecht(xplan_position);
...
CREATE INDEX spatial_idx_322 ON xplansyn.xplan_so_gelaendemorphologie(xplan_position);
