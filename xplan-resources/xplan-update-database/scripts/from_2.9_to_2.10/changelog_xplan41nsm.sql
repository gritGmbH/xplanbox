...
-- Lock Database
UPDATE xplan41nsm.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'lgvxplanisk.fritz.box (192.168.178.152)', LOCKGRANTED = '2018-11-29 12:30:49.961' WHERE ID = 1 AND LOCKED = FALSE;
