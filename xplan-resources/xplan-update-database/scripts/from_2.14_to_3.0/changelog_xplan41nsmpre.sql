...
-- Lock Database
UPDATE xplan41nsmpre.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = '172.22.0.1 (172.22.0.1)', LOCKGRANTED = '2019-10-29 16:04:07.189' WHERE ID = 1 AND LOCKED = FALSE;
