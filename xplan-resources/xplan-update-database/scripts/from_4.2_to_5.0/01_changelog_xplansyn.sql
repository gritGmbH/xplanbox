...
-- Lock Database
UPDATE xplansyn.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'cpe-172-101-0-1.maine.res.rr.com (172.101.0.1)', LOCKGRANTED = '2022-01-12 07:36:54.324' WHERE ID = 1 AND LOCKED = FALSE;
...
-- Changeset changelog_xplansyn.xml::1641969283797-1::lyn (generated)
