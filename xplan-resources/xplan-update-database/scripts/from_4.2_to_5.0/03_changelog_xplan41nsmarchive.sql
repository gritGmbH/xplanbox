...
-- Lock Database
UPDATE xplan41nsmarchive.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'cpe-172-101-0-1.maine.res.rr.com (172.101.0.1)', LOCKGRANTED = '2022-03-18 07:38:57.887' WHERE ID = 1 AND LOCKED = FALSE;
...
-- Changeset changelog_xplan41nsmarchive.xml::1647585352034-1::lyn (generated)
ALTER TABLE xplan41nsmarchive.gml_objects DROP CONSTRAINT gml_objects_ft_type_fkey;

INSERT INTO xplan41nsmarchive.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1647585352034-1', 'lyn (generated)', 'changelog_xplan41nsmarchive.xml', NOW(), 1, '8:b72c0c0142a648d5a2dd8ddfa9edc0f5', 'dropForeignKeyConstraint baseTableName=gml_objects, constraintName=gml_objects_ft_type_fkey', '', 'EXECUTED', NULL, NULL, '3.6.2', '7585538380');

-- Changeset changelog_xplan41nsmarchive.xml::1647585352034-2::lyn (generated)
ALTER TABLE xplan41nsmarchive.gml_objects DROP CONSTRAINT gml_objects_gml_id_key;

INSERT INTO xplan41nsmarchive.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1647585352034-2', 'lyn (generated)', 'changelog_xplan41nsmarchive.xml', NOW(), 2, '8:696b2059e12b8275be2cf6b457071afb', 'dropUniqueConstraint constraintName=gml_objects_gml_id_key, tableName=gml_objects', '', 'EXECUTED', NULL, NULL, '3.6.2', '7585538380');

-- Changeset changelog_xplan41nsmarchive.xml::1647585352034-3::lyn (generated)
DROP TABLE xplan41nsmarchive.feature_types;

INSERT INTO xplan41nsmarchive.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1647585352034-3', 'lyn (generated)', 'changelog_xplan41nsmarchive.xml', NOW(), 3, '8:54533b1d53f0a77a255e615b8353e5af', 'dropTable tableName=feature_types', '', 'EXECUTED', NULL, NULL, '3.6.2', '7585538380');

-- Changeset changelog_xplan41nsmarchive.xml::1647585352034-4::lyn (generated)
DROP TABLE xplan41nsmarchive.gml_objects;

INSERT INTO xplan41nsmarchive.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1647585352034-4', 'lyn (generated)', 'changelog_xplan41nsmarchive.xml', NOW(), 4, '8:ce6206e1178dd14409dbd9ab837c06d8', 'dropTable tableName=gml_objects', '', 'EXECUTED', NULL, NULL, '3.6.2', '7585538380');
