...
public class UpdaterFrom1_0To1_3_1 extends AbstractUpdater {
    ...
    static {
        PLAN_TABLE_METADATA.put( BP_Plan, new PlanTableMetadata( "xplan_bp_plan", "xplan_bp_bereich",
                        "xplan_" + BP_RELEASE_DATE_PROP_NAME ) );
        PLAN_TABLE_METADATA.put( LP_Plan, new PlanTableMetadata( "xplan_lp_plan", "xplan_lp_bereich",
                        "xplan_" + LP_RELEASE_DATE_PROP_NAME ) );
        PLAN_TABLE_METADATA.put( FP_Plan, new PlanTableMetadata( "xplan_fp_plan", "xplan_fp_bereich",
                        "xplan_" + FP_RELEASE_DATE_PROP_NAME ) );
        PLAN_TABLE_METADATA.put( RP_Plan, new PlanTableMetadata( "xplan_rp_plan", "xplan_rp_bereich",
                        "xplan_" + RP_RELEASE_DATE_PROP_NAME ) );
    ...
    private void updateXPlanSynTables( Connection conn )
                    throws Exception {
        try {
    ...
    private void updateXPlanSynTable( Connection conn, DatabaseMetaData metaData, String tableName )
                    throws SQLException {
    ...
    private void updateXPlanSynTableWithBereichReference( Connection conn, String tableName,
                                                          List<String> bereichReferenceColumnNames )
                                                                          throws SQLException {
    ...
    private void executeUpdate( Connection conn, String updateSql, String tableName, String gmlId,
                                String referenceId ) {
