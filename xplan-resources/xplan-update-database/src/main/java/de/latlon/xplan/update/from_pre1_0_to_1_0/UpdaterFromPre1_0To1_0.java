...
public class UpdaterFromPre1_0To1_0 extends AbstractUpdater {
	...
	private void updateXplanMgrPlansTable(List<XPlan> plans, Connection conn) throws Exception {
	...
	private void updateXPlanMgrTable(XPlan plan, Connection conn) throws Exception {
		try {
