...
/**
 * Updates the data in the tables xplanmgr.plans and xplan3.gml_object. Schema must be up
 * to date already.
 *
...
public class DatabaseDataUpdater {
	 ...
	 * @param versions a list of {@link UPDATE_VERSION}s to execute, never
	 * <code>null</code>
	 * @throws Exception if an error occurred during update
	 */
	public void updateData(List<UPDATE_VERSION> versions) throws Exception {
