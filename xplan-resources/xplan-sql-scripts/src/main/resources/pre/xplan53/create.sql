...
---
/* --- BEGIN schema setup --- */
CREATE SCHEMA xplan53pre;
SET search_path TO xplan53pre,public;
...
SELECT ADDGEOMETRYCOLUMN('xplan53pre', 'feature_types','bbox','25832','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan53pre', 'gml_objects','gml_bounded_by','25832','GEOMETRY',2);
