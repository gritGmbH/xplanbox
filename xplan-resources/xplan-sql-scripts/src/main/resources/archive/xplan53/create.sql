...
SELECT ADDGEOMETRYCOLUMN('xplan53archive', 'feature_types','bbox','0','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan53archive', 'gml_objects','gml_bounded_by','0','GEOMETRY',2);
