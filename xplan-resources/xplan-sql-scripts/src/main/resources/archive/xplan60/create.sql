...
SELECT ADDGEOMETRYCOLUMN('xplan60archive', 'feature_types','bbox','0','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan60archive', 'gml_objects','gml_bounded_by','0','GEOMETRY',2);
