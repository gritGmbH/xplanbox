...
---
/* --- BEGIN schema setup --- */
CREATE SCHEMA xplan60archive;
SET search_path TO xplan60archive,public;
...
SELECT ADDGEOMETRYCOLUMN('xplan60archive', 'feature_types','bbox','25832','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan60archive', 'gml_objects','gml_bounded_by','25832','GEOMETRY',2);
