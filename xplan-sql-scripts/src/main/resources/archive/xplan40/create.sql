...
SELECT ADDGEOMETRYCOLUMN('xplan40archive', 'feature_types','bbox','-1','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan40archive', 'gml_objects','gml_bounded_by','-1','GEOMETRY',2);
