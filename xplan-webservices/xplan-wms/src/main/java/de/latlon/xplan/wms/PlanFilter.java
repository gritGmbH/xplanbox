...
public class PlanFilter implements Filter {
    ...
    private void modifyPlanRequest( RequestParameterWrapper wrappedRequest )
                    throws ServletException {
    ...
    private String checkTypeParameterAndRetrieveLayers( RequestParameterWrapper wrappedRequest )
                    throws ServletException {
    ...
    private void checkManadatoryRequestParameters( HttpServletRequest request )
                    throws ServletException {
    ...
    private void checkRequestParameter( HttpServletRequest request, String parameterName )
                    throws ServletException {
