...
(
  every $h in //BP_GemeinbedarfsFlaeche[weitereBesondZweckbestimmung1] satisfies
...
and
(
  every $h in //BP_GemeinbedarfsFlaeche[weitereBesondZweckbestimmung2] satisfies
...
and
(
  every $h in //BP_GemeinbedarfsFlaeche[weitereBesondZweckbestimmung3] satisfies
...
and
(
  every $h in //BP_GemeinbedarfsFlaeche[weitereBesondZweckbestimmung4] satisfies
