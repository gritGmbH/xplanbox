...
(
  every $h in //FP_VerEntsorgung[weitereBesondZweckbestimmung1] satisfies
...
and
(
  every $h in //FP_VerEntsorgung[weitereBesondZweckbestimmung2] satisfies
...
and
(
  every $h in //FP_VerEntsorgung[weitereBesondZweckbestimmung3] satisfies
