...
(
  ...
  (exists($h/ZUzwingend) and not(exists($h/ZUmin)) and not(exists($h/ZUmax)) and not(exists($h/ZU))) or
  (not(exists($h/ZUzwingend)) and not(exists($h/ZUmin)) and not(exists($h/ZUmax)) and not(exists($h/ZU)))
)
and
(
