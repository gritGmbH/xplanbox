...
import de.latlon.xplan.update.updater.DistrictUpdaterApplicationRunner;
...
public class DistrictUpdateTool {
	...
	public static void main(String[] args) {
		if (args.length > 0 && ("--help".equals(args[0]) || "-help".equals(args[0]) || "-h".equals(args[0]))) {
			...
			SpringApplication app = new SpringApplication(DistrictUpdaterApplicationRunner.class);
	...
	private static void printUsage() {
		System.out.println("Update column district of table xplanmgr.plans.");
		System.out.println();
		System.out.println("Usage: districtUpdate");
		System.out.println();
