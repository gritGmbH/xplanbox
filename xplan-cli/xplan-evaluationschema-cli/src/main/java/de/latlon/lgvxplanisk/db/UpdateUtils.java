...
public class UpdateUtils {
    ...
    /**
     * @param planstatus
     *                 the status of the plan, may be null <code>null</code>
     * @return the syn database schema where plans with the passed planstatus are stored, <code>null</code> if the passsed planstatus is <code>null</code>
     * @throws IllegalArgumentException
     *                 if the planstatus is not uspported
     */
     ...
     * @return the blob database schema plans with the passed version are stored, never <code>null</code>
     * @throws IllegalArgumentException
     *                 if the version is not uspported
     */
    ...
    /**
     * @param columnname
     *                 the name of the geometry column, never <code>null</code>
     * @return the XPath expression to select the geometry, never <code>null</code>
     * @throws IllegalArgumentException
     *                 if the columnname is not uspported
     */
    ...
    /**
     * @param schemaname
     *                 the name of the blob database schema, never <code>null</code>
     * @return the namespace of the XPlanGML stored in this database schema, never <code>null</code>
     * @throws IllegalArgumentException
     *                 if the schemaname is not uspported
     */
