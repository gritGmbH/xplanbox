package de.latlon.lgvxplanisk.db;
...
import static de.latlon.lgvxplanisk.db.UpdateUtils.detectBlobSchemaByVersion;
import static de.latlon.lgvxplanisk.db.UpdateUtils.detectNamespace;
import static de.latlon.lgvxplanisk.db.UpdateUtils.detectSynSchemaByPlanStatus;
import static de.latlon.lgvxplanisk.db.UpdateUtils.detectXPath;
 ...
 */
public class LgvSynSchemaSynchronizer implements Synchronizer {

    private static final Logger LOG = LogManager.getLogger( LgvSynSchemaSynchronizer.class );
    ...
    public void synchronize( Connection conn, int oldid, int newid, int xPlanManagerId, String planVersion,
        ...
        try {
            ...
            while ( rs.next() ) {
                ...
                synchronizeTable( conn, xPlanManagerId, oldSynSchema, newSynSchema, blobSchema, operation,
                                  synTableName );
            }
    ...
    private void synchronizeTable( Connection conn, int xPlanManagerId, String oldSynSchema, String newSynSchema,
                                   String blobSchema, Operation operation, String synTableName )
                    throws SQLException {
    ...
    private void updateGeomColumn( int xPlanManagerId, Connection conn, String synSchema, String blobSchema,
                                   String synTableName, String geomColumn )
                    throws SQLException {
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            ...
            selectGmlGeom.append( "XMLPARSE(CONTENT encode(binary_object, 'escape')), ARRAY[ARRAY['xplan', '" ).append(
                            namespace ).append( "']]),',') " );
    ...
    private int update( Connection conn, String synTableWithSchema, String geomColumn, String gmlId, String gmlGeom )
        ...
        try {
            ...
            if ( geom != null ) {
                ...
                updateGeomColumn.append( " SET " ).append( geomColumn ).append(
                                " = ST_GeomFromWKB( ? ) WHERE xplan_gmlid = ?" );
