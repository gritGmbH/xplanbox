...
public class XPlanRasterManagerCLI {
	...
	private static void moveLayer(String[] args) throws Exception {
		if (args.length < 3) {
			printUsage();
		}
		String type = args[1];
	...
	private static void removeCategory(String[] args) throws Exception {
		if (args.length != 3) {
			printUsage();
		}
		String type = args[1];
	...
	private static void addCategory(String[] args) throws Exception {
	...
	private static void removeLayer(String[] args) throws Exception {
		if (args.length != 3) {
			printUsage();
		}
		String type = args[1];
	...
	private static void addLayer(String[] args) throws Exception {
