...
public class SemanticInvalidRuleResult {
    ...
    private @Valid
    List<String> invalidGmlIds = new ArrayList<String>();
    ...
    public boolean equals( Object o ) {
        ...
        return Objects.equals( message, that.message ) && Objects.equals( invalidGmlIds,
                                                                          that.invalidGmlIds );
    }
    ...
    public String toString() {
        return "SemanticInvalidRuleResult{" +
               "message='" + message + '\'' +
               ", invalidGmlIds=" + invalidGmlIds +
               '}';
    }
}
