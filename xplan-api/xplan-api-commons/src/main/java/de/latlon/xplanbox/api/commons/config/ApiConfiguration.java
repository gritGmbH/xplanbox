...
public abstract class ApiConfiguration {
     ...
     *                 loader to retrieve the properties, never <code>null</code>
     ...
     * @throws ConfigurationException
     *                 if the property is not a valid URL
     */
    protected URI parseUri( Properties properties, String propName )
                    throws ConfigurationException {
     ...
     *                 the name of the property, never <code>null</code>
     * @param defaultValue
     *                 to return if the property is not configured
