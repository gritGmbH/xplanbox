...
import de.latlon.xplanbox.api.manager.v1.model.ManagerSystemConfigAllOf;
import de.latlon.xplanbox.api.manager.v1.model.RulesMetadata;
import de.latlon.xplanbox.api.manager.v1.model.SystemConfig;
...
public enum SupportedXPlanGmlVersionsEnum {
   ...
   **/
  public ManagerSystemConfig supportedXPlanGmlVersions(List<SupportedXPlanGmlVersionsEnum> supportedXPlanGmlVersions) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.version, managerSystemConfig.version) &&
        Objects.equals(this.rulesMetadata, managerSystemConfig.rulesMetadata) &&
        Objects.equals(this.supportedXPlanGmlVersions, managerSystemConfig.supportedXPlanGmlVersions) &&
        Objects.equals(this.rasterCrs, managerSystemConfig.rasterCrs) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, rulesMetadata, supportedXPlanGmlVersions, rasterCrs, rasterType, skipSemantisch, skipGeometrisch, skipFlaechenschluss, skipGeltungsbereich);
  }
