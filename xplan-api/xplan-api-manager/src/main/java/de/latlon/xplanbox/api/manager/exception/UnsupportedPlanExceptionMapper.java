 ...
 */
@Provider
public class UnsupportedPlanExceptionMapper implements ExceptionMapper<UnsupportPlanException> {

	@Override
	public Response toResponse(UnsupportPlanException exception) {
