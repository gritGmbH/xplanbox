...
public class ValidationHandlerTest {
    ...
    @Test
    public void verifyThat_ValidPlan_ReturnsValidReport() throws IOException, ValidatorException, URISyntaxException {
        ...
        ValidatorReport report = validationHandler.validate( file, "noName", settings );
    ...
    @Test
    public void verifyThat_PlanwerkWmsUrl_IsAddedToIncompleteValidationHandler_NullIsReturned() throws URISyntaxException {
        final File file = new File( ValidationHandlerTest.class.getResource("/xplan.gml").toURI() );

        URI wmsUrl = validationHandler.addToWms( file );
        assertNull( wmsUrl );
    }
}