...
/**
 * Implements the {@link Format} of {@link DateBox} to be more strict by validation/parsing. Sets the style class to
 * EDITOR_VALIDATION_ERROR and adds a tooltip if input is invalid.
 * 
