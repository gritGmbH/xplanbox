...
public class MapPreviewDialog extends DialogBox {
    ...
    private final ManagerWebConfigurationServiceAsync configrationService = GWT.create( ManagerWebConfigurationService.class );
    ...
    private void
                    transformIfRequired( XPlanEnvelope bbox, LonLat min, LonLat max,
                                         MapPreviewConfiguration configuration ) {
    ...
    private void createAndAddUrlButton( SimplePanel contentPanel, MapPreviewConfiguration configuration,
                                        String planType, PlanStatus planStatus, Bounds bounds ) {
