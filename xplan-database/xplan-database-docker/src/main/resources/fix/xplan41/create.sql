...
---
/* --- BEGIN schema setup --- */
CREATE SCHEMA xplan41;
SET search_path TO xplan41,public;
/* --- END schema setup --- */
...
SELECT ADDGEOMETRYCOLUMN('xplan41', 'feature_types','bbox','25832','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan41', 'gml_objects','gml_bounded_by','25832','GEOMETRY',2);
