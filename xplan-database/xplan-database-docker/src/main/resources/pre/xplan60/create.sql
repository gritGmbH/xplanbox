...
---
/* --- BEGIN schema setup --- */
CREATE SCHEMA xplan60pre;
SET search_path TO xplan60pre,public;
...
SELECT ADDGEOMETRYCOLUMN('xplan60pre', 'feature_types','bbox','25832','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan60pre', 'gml_objects','gml_bounded_by','25832','GEOMETRY',2);
