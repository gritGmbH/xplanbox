...
---
/* --- BEGIN schema setup --- */
CREATE SCHEMA xplan41pre;
SET search_path TO xplan41pre,public;
/* --- END schema setup --- */
...
SELECT ADDGEOMETRYCOLUMN('xplan41pre', 'feature_types','bbox','25832','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan41pre', 'gml_objects','gml_bounded_by','25832','GEOMETRY',2);
