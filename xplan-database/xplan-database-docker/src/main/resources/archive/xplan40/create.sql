...
---
/* --- BEGIN schema setup --- */
CREATE SCHEMA xplan40archive;
SET search_path TO xplan40archive,public;
/* --- END schema setup --- */
...
SELECT ADDGEOMETRYCOLUMN('xplan40archive', 'feature_types','bbox','25832','GEOMETRY',2);
...
SELECT ADDGEOMETRYCOLUMN('xplan40archive', 'gml_objects','gml_bounded_by','25832','GEOMETRY',2);
