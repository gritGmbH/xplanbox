...
Externe Codelisten können im Verzeichnis <MANAGER_WEB>/synthesizer abgelegt werden. Dabei weißt die Variable <MANAGER_WEB> auf das Verzeichnis, in dem sich der Ordner _manager-configuration_ begfindet (s.a. 4.3.1 Konfiguration und 4.5.1 Anwendungs-Tomcat).
