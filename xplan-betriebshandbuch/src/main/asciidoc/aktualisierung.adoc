...
=== Übersicht - Aktualisierungsschritte, die die Datenhaltung betreffen, sind zwingend notwendig

Folgende Tabelle listet auf, bei welchen xPlanBox Versionen zwingend Aktualisierungsschritte notwendig sind, die die Datenhaltung betreffen.
Die Details zu dem jeweiligen Aktualisierungsschritt werden in den dazugehörigen vorigen Kapiteln erläutert.

Diese Tabelle dient lediglich der besseren Übersicht und ist bezüglich älterer xPlanBox Versionen (vor Version 2.3) lückenhaft. Falls Sie mehr Details zu einem Aktualisierungsvorhaben vor Version 2.3 wünschen, wenden Sie sich bitte an die http://www.lat-lon.de[lat/lon GmbH].

[options="header"]
|=================
| xPlanBox Version | Aktualisierung Workspaces notwendig | Aktualisierung Schemas notwendig | Aktualisierung Daten notwendig |
| 1.0 | | ja | ja |
| 1.3.1 | | ja | ja |
| 1.8 | | ja | |
| 2.0 | ja | ja | ja |
