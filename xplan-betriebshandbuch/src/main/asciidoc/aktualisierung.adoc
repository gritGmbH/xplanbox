...
|====================================
| xPlanBox Version | Änderungen an den Workspaces? | Änderungen am Datenbankschema?
| 2.0              | ja                            | ja
| 2.2              |                               | ja
| 2.4              | ja                            |
...
Mit der Version 2.7 bietet die xPlanBox die Möglichkeit die vom XPlanManager verwalteten Pläne im Datenthema Planned Land Use (PLU) bereitzustellen. Um diese Option für eine bestehende Installation zu aktivieren, sind folgende Schritte notwendig:
