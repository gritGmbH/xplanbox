...
Folgende Tabelle listet auf, bei welchen xPlanBox Versionen die Datenhaltung betreffende Änderungen im Vergleich zur vorherigen Version vorgenommen wurden.
Änderungen werden grundsätzlich nur bei höheren Versionen vorgenommen, Bugfix-Versionen (dritte Stelle in der Versionsangabe, z.B. die 1 in 2.3.1) enthalten keine Änderungen. In der Tabelle sind nur Versionen aufgelistet, die auch Änderungen enthalten. In der Version 2.3 wurden gegenüber der Version 2.2 beispielsweise keine Änderungen vorgenommen.
...
|=================
| xPlanBox Version | Änderungen am Workspaces? | Änderungen am Datenbankschema? | Änderung der Daten?
| 2.0 | ja | ja | ja
| 2.2 |    | ja | ja
| 2.4 | ja |    |
|Hinweise zur Aktualisierung | <<aktualisierung-der-betroffenen-konfigurationsdateien-in-den-workspaces>> | <<aktualisierung-der-schemas>> | <<aktualisierung-der-daten>>
|=================
