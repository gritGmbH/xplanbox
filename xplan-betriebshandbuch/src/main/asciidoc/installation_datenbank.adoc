...
Alternativ zur Konfiguration von ConnectionsPools für den ZUgriff auf die Datenbank kann auch eine JNDI DataSource konfiguriert werden. Details dazu finden sich im Handbuch von deegree.