...
/**
 * Contains the configuration which feature type/property name should be used to fill the sort property in Syn WMS.
 * 
...
public class SortConfiguration {
    ...
    /**
     * Adds a new featureType and propertyName to this {@link SortConfiguration}. If a configuration option with the
     * same planType and version was already added, the new one overwrites the existing.
     * 
     * @param planType
     ...
     * @param featureType
     *            the name of the feature type used to find the sort value, may be <code>null</code> if not configured
     * @param propertyName
     *            the name of the feature types property used to find the sort value, may be <code>null</code> if not
     *            configured
    ...
    /**
     * @param planType
     *            the type of the plan, may be <code>null</code>
     * @param version
     *            the version of the plan, may be <code>null</code>
     * @return the name of the feature type used to find the sort value, may be <code>null</code> if not configured
     */
     ...
     * @param version
     *            the version of the plan, may be <code>null</code>
     * @return the name of the feature types property used to find the sort value, may be <code>null</code> if not
     *         configured
     */
