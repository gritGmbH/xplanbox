...
public enum PlanStatus {
     ...
     * 
     * @param mesage
     *            of the plan status to return
     * @return the {@link PlanStatus} with the passed message, never <code>null</code>
     * @throws IllegalArgumentException
     *             if no {@link PlanStatus} with the message exists (or message is <code>null</code>)
     */
     ...
     *            the legislation status code of the plan
     * @return the {@link PlanStatus} assigned to the legislation status code, never <code>null</code>
     */
