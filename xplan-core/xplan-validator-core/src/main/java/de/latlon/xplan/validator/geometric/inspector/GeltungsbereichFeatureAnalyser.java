...
public class GeltungsbereichFeatureAnalyser {
     ...
     * @return <code>true</code> if the feature is a X_Plan feature, <code>false</code> otherwise
     */
     ...
     * @param feature
     *                         never <code>null</code>
     * @return <code>true</code> if the feature is a X_Bereich feature, <code>false</code> otherwise
     */
     ...
     * @param feature
     *                         never <code>null</code>
     * @return <code>true</code> if the feature is allowed to be outside of the geltungsbereich, <code>false</code> otherwise
     */
     ...
     * @param feature
     *                         never <code>null</code>
     * @return the id of the bereich this feature belongs to, <code>null</code> is not assigned to a bereich
     */
     ...
     * @param feature
     *                         never <code>null</code>
     * @return the geometry of the feature as JTS geometry, <code>null</code> if the feature has no geometry
     */
     ...
     * @param feature
     *                         never <code>null</code>
     * @return the geometry of the feature, <code>null</code> if the feature has no geometry
     */
