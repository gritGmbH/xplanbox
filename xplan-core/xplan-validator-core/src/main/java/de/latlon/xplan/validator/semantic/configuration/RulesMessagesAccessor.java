...
public final class RulesMessagesAccessor {
    ...
    /**
     * @param rule
     *            to retrieve message for, may be <code>null</code> (default message is returned)
     * @param version
     *            the rule is assigned to, may be <code>null</code>
     * @return the message for the passed rule and version or for the passed rule if version is <code>null</code> or not
     *         known, a default message if a property with this name could not be found, never <code>null</code>
     */
