...
public class XplanFlattenPropertyTest {
    ...
    public void testEvaluateWithXpHoehenangabe() {
        ...
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:hoehenangabe" ),
                                                              new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
        assertEquals( "[abweichenderHoehenbezug=1;hoehenbezug=absolutNHN;bezugspunkt=FH;hMin=1;hMax=2;hZwingend=3;h=4;]",
                      value.toString() );
    }
    ...
    public void testEvaluate50XpTextAbschnitt() {
        Feature feature = new ScenarioLoader().getTestFeature( XPLAN_50, "BP_Plan" );
        XplanFlattenProperty expr = new XplanFlattenProperty( new Xpath( "xplan:texte" ), new XPlanSynthesizer() );
        PrimitiveValue value = expr.evaluate( feature );
