...
public class XPlanCodeListsFactory {
    ...
    public static synchronized XPlanCodeLists getXPlanSyn() {
        if ( xplanSynCodeLists == null ) {
            try {
                xplanSynCodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_SYN_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
    ...
    public static synchronized XPlanCodeLists getXPlan3Ext() {
        if ( xplan3ExtCodeLists == null ) {
            try {
                xplan3ExtCodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_3_EXT_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
                throw new RuntimeException( msg );
            }
    ...
    public static synchronized XPlanCodeLists getXPlanSynExt() {
        if ( xplanSynExtCodeLists == null ) {
            try {
                xplanSynExtCodeLists = mergeCodeLists( xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_SYN_EXT_CODE_LISTS_XP3 ), GML_30 ),
                                                       xPlanCodeListParser.parseCodelists(
                                                                               XPlanCodeLists.class.getResource(
                                                                                                       XPLAN_SYN_EXT_CODE_LISTS_XP2 ),
                                                                               GML_30 ) );
            } catch ( Exception e ) {
    ...
    private static synchronized XPlanCodeLists getXPlan3() {
        if ( xplan3CodeLists == null ) {
            try {
                xplan3CodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_3_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
    ...
    private static synchronized XPlanCodeLists getXPlan40() {
        if ( xplan40CodeLists == null ) {
            try {
                xplan40CodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_40_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
                throw new RuntimeException( msg, e );
            }
    ...
    private static synchronized XPlanCodeLists getXPlan41() {
        if ( xplan41CodeLists == null ) {
            try {
                xplan41CodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_41_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
                throw new RuntimeException( msg, e );
            }
    ...
    private static synchronized XPlanCodeLists getXPlan50() {
        if ( xplan50CodeLists == null ) {
            try {
                xplan50CodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_50_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
                throw new RuntimeException( msg, e );
            }
    ...
    private static synchronized XPlanCodeLists getXPlan51() {
        if ( xplan51CodeLists == null ) {
            try {
                xplan51CodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_51_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
                throw new RuntimeException( msg, e );
            }
        ...
        if ( xplan52CodeLists == null ) {
            try {
                xplan52CodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_52_CODE_LISTS ), GML_30 );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
                throw new RuntimeException( msg, e );
            }
    ...
    private static synchronized XPlanCodeLists getXPlan53() {
        if ( xplan53CodeLists == null ) {
            try {
                xplan53CodeLists = xPlanCodeListParser.parseCodelists(
                                        XPlanCodeLists.class.getResource( XPLAN_53_CODE_LISTS ) );
            } catch ( Exception e ) {
                String msg = "Internal error reading code lists file: " + e.getMessage();
                throw new RuntimeException( msg, e );
            }
