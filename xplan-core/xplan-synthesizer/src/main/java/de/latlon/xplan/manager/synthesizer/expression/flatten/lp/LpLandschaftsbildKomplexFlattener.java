 ...
 */
public class LpLandschaftsbildKomplexFlattener extends AbstractFlattener {

	@Override
	public boolean accepts(TypedObjectNode node) {
		return acceptsElementNode(node, "LP_LandschaftsbildKomplex");
	}
	...
	public String flatten(TypedObjectNode node, boolean translateCodes) {
		...
		appendCode("Art", node, "landschaftsbildArt", version, "LP_LandschaftsbildArt", translateCodes, properties);
		append("Erläuterung", node, "landschaftsbildText", properties);
