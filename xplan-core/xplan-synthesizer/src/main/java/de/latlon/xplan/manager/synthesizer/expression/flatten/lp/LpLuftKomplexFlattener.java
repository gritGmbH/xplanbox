 ...
 */
public class LpLuftKomplexFlattener extends AbstractFlattener {

	@Override
	public boolean accepts(TypedObjectNode node) {
		return acceptsElementNode(node, "LP_LuftKomplex");
	}
	...
	public String flatten(TypedObjectNode node, boolean translateCodes) {
		...
		appendCode("Art", node, "luftArt", version, "LP_LuftArt", translateCodes, properties);
		append("Erläuterung", node, "luftText", properties);
