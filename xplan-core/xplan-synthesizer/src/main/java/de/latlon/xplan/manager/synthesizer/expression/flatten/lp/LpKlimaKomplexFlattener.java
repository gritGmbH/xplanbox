 ...
 */
public class LpKlimaKomplexFlattener extends AbstractFlattener {

	@Override
	public boolean accepts(TypedObjectNode node) {
		return acceptsElementNode(node, "LP_KlimaKomplex");
	}
	...
	public String flatten(TypedObjectNode node, boolean translateCodes) {
		...
		appendCode("Art", node, "klimaArt", version, "LP_KlimaArt", translateCodes, properties);
		append("Erläuterung", node, "klimaText", properties);
