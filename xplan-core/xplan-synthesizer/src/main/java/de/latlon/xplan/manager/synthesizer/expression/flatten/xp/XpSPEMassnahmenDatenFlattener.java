...
public class XpSPEMassnahmenDatenFlattener extends AbstractFlattener {
	...
	public boolean accepts(TypedObjectNode node) {
		return acceptsElementNode(node, "XP_SPEMassnahmenDaten");
	}

	@Override
	public String flatten(TypedObjectNode xpSPEMassnahmenDaten, boolean translateCodes) {
		...
		appendCode("Maßnahme", xpSPEMassnahmenDaten, "klassifizMassnahme", version, "XP_SPEMassnahmenTypen",
