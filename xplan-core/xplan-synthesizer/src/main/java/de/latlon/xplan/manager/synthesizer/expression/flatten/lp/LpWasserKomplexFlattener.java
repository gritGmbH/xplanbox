 ...
 */
public class LpWasserKomplexFlattener extends AbstractFlattener {

	@Override
	public boolean accepts(TypedObjectNode node) {
		return acceptsElementNode(node, "LP_WasserKomplex");
	}
	...
	public String flatten(TypedObjectNode node) {
		...
		appendTranslatedCode("Ausprägung", node, "wasserAuspraegung", version, "LP_WasserAuspraegung", properties);
		append("Erläuterung", node, "wasserText", properties);
