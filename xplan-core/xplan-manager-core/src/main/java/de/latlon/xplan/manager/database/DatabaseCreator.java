...
public class DatabaseCreator {
	 ...
	 * @param jdbcConnection connection string
	 * @param dbName database name
	 * @param template database template
	 * @param user database user
	 * @param pw user's password
	 * @param wsDirectory workspace directory
	 * @throws SQLException schema creation fails
	 * @throws java.io.FileNotFoundException if at least one database script is missing
	 * @throws java.sql.SQLException if database creation fails
	 */
	public void createInitialDB(String jdbcConnection, String dbName, String template, String user, String pw,
			File wsDirectory) throws SQLException, IOException {
	...
	private void createDatabase(String dbName, String template, Connection connection) throws SQLException {
	...
	private void createInitialSchemas(String jdbcConnection, String dbName, File wsDirectory, String user, String pw)
		...
		try (Connection connection = DriverManager.getConnection(jdbcConnection + "/" + dbName, user, pw)) {
			...
			FileReader xplan41nsmarchive = new FileReader(
					wsDirectory.toString() + "/sql/archive/xplan41nsm/create.sql");
