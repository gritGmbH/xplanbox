...
public class WorkspaceUtils {
    ...
    /**
     * @param workspaceName
     *            name of the workspace to instantiates, never <code>null</code>
     * @param workspaceDir
     *            directory to use as workspace, used if the default directory does not contain a workspace with the
     *            given name, may be <code>null</code>
     * @return the instantiated workspace, if a workspace with the given name or in the directory exist, never
     *         <code>null</code>
     * @throws Exception
     *             - an exception occurred during instantiation or a workspace with the given name does not exist
     */
     ...
     *            directory to use as workspace, used if the default directory does not contain a workspace with the
     *            given name, may be <code>null</code>
     * @return the instantiated workspace, if a workspace on the given path exist, never <code>null</code>
     * @throws Exception
     *             - an exception occurred during instantiation or a workspace with the given name does not exist
     */
    public static DeegreeWorkspace instantiateWorkspace( File workspaceDir )
                    throws WorkspaceException {
    ...
    /**
     * @param workspaceName
     *            name of the workspace to instantiates, never <code>null</code> given name, may be <code>null</code>
     * @return the instantiated workspace, if a workspace with the given name or in the directory exist, never
     *         <code>null</code>
     * @throws Exception
     *             - an exception occurred during instantiation or a workspace with the given name does not exist
     */
    public static DeegreeWorkspace instantiateWorkspace( String workspaceName )
                    throws WorkspaceException {
        ...
        try {
            ...
            throw new WorkspaceException( "Fehler: Workspace '" + workspaceName
                                          + "' konnte nicht initialisiert werden: " + e.getMessage(), e );
        }
    }

    /**
     * @param workspaceDir
     *            directory to use as workspace, may be <code>null</code>
     * @return the location of the workspace (passed directory or the workspace with default name
     *         ('xplansyn-wms-workspace') in the deegree.home directory) if exist, never <code>null</code>
     * @throws Exception
     *             - if a workspace with the given name does not exist
     */
    public static File findWorkspaceDirectory( File workspaceDir )
                    throws Exception {
    ...
    public static DeegreeWorkspace instantiateManagerWorkspace( File workspaceDir )
            throws Exception {
        if ( workspaceDir != null )
            return instantiateWorkspace( workspaceDir );
    ...
    private static DeegreeWorkspace instantiateWorkspaceByNameAndDir( File workspaceDir, String workspaceName )
        ...
        try {
            ...
            throw new WorkspaceException( "Fehler: Workspace '" + workspaceName + "' konnte nicht gefunden werden: "
                                          + e.getMessage(), e );
        }
    ...
    private static File findWorkspaceDirectoryByDir( File workspaceDir )
                    throws WorkspaceException {
        ...
        try {
            ...
            throw new WorkspaceException( "Fehler: Workspace at '" + workspaceDir + "' konnte nicht gefunden werden: "
                                          + e.getMessage(), e );
        }
        if ( !workspace.getLocation().exists() )
    ...
    private static File findWorkspaceDirectoryByName( String workspaceName )
                    throws WorkspaceException {
        LOG.info( "get workspace instance with name {} from deegree.home", workspaceName );
        DeegreeWorkspace workspace = getInstance( workspaceName );
