...
public class InternalIdRetriever {
     ...
     * 
     * @param configuration
     *            for this {@link InternalIdRetriever}, never <code>null</code>
     ...
     * 
     * @param matchString
     *            plan name to match with the internal id
     * @throws ConfigurationException
     */
    public Map<String, String> getMatchingInternalIds( String matchString )
                    throws ConfigurationException {
     ...
     * @throws ConfigurationException
     */
    public Map<String, String> getAllInternalIds()
                    throws ConfigurationException {
     ...
     * @throws ConfigurationException
     */
    Connection createConnectionFromWorkspace()
                    throws ConfigurationException {
     ...
     *
     * @param matchString
     *            string to match with '?' from sql, may be <code>null</code>
     * @param sql
     *            sql statement, never <code>null</code>
     * @param conn
     *            connection, never <code>null</code>
     * @return prepared statement
     * @throws SQLException
     */
    PreparedStatement retrievePreparedStatement( String matchString, String sql, Connection conn )
                    throws SQLException {
     ...
     * @throws SQLException
     */
    ResultSet retrieveResultSet( PreparedStatement ps )
                    throws SQLException {
        return ps.executeQuery();
    }

    private Map<String, String> getInternalIdsFromStatement( String sql )
                    throws ConfigurationException {
    ...
    private Map<String, String> collectResultSet( ResultSet rs )
                    throws SQLException {
